...
//    EventReader reader = new EventReader();
//    Event event = reader.read(json);
//    Assertions.assertTrue(event.getEventType() instanceof Data);
//  }
//
//  /**
...
//    EventReader reader = new EventReader();
//    Event event = reader.read(json);
//    Assertions.assertTrue(event.getEventType() instanceof Pipeline);
//    Pipeline pipeline = (Pipeline) event.getEventType();
