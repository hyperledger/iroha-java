...
public sealed class FilterOptOfAssetDefinitionFilter : ModelEnum {
    ...
    public class AcceptAll : FilterOptOfAssetDefinitionFilter() {
        ...
        public companion object : ScaleReader<AcceptAll>, ScaleWriter<AcceptAll> {
            ...
            public override fun hashCode(): Int = ".FilterOptOfAssetDefinitionFilter.AcceptAll".hashCode()
        }
    }
    ...
    public companion object :
        ...
        public override fun read(reader: ScaleCodecReader): FilterOptOfAssetDefinitionFilter = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptOfAssetDefinitionFilter) {
