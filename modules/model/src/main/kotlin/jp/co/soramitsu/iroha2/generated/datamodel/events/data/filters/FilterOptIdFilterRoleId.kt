 ...
 *
 * Generated from 'iroha_data_model::events::data::filters::FilterOptIdFilterRoleId' enum
 */
public sealed class FilterOptIdFilterRoleId : ModelEnum {
    /**
     ...
     * 'AcceptAll' variant
     */
    public class AcceptAll : FilterOptIdFilterRoleId() {
    ...
    public companion object :
        ScaleReader<FilterOptIdFilterRoleId>,
        ScaleWriter<FilterOptIdFilterRoleId> {
        public override fun read(reader: ScaleCodecReader): FilterOptIdFilterRoleId = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptIdFilterRoleId) {
