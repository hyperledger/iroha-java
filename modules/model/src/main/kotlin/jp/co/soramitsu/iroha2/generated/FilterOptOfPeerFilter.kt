...
public sealed class FilterOptOfPeerFilter : ModelEnum {
    ...
    public class AcceptAll : FilterOptOfPeerFilter() {
        ...
        public companion object : ScaleReader<AcceptAll>, ScaleWriter<AcceptAll> {
            ...
            public override fun hashCode(): Int = ".FilterOptOfPeerFilter.AcceptAll".hashCode()
        }
    }
    ...
    public companion object : ScaleReader<FilterOptOfPeerFilter>, ScaleWriter<FilterOptOfPeerFilter> {
        public override fun read(reader: ScaleCodecReader): FilterOptOfPeerFilter = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptOfPeerFilter) {
