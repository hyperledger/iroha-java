...
public sealed class FilterOptOfTriggerFilter : ModelEnum {
    ...
    public class AcceptAll : FilterOptOfTriggerFilter() {
        ...
        public companion object : ScaleReader<AcceptAll>, ScaleWriter<AcceptAll> {
            ...
            public override fun hashCode(): Int = ".FilterOptOfTriggerFilter.AcceptAll".hashCode()
        }
    }
    ...
    public companion object :
        ...
        public override fun read(reader: ScaleCodecReader): FilterOptOfTriggerFilter = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptOfTriggerFilter) {
