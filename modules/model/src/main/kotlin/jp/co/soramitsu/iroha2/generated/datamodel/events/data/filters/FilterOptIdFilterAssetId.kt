 ...
 *
 * Generated from 'iroha_data_model::events::data::filters::FilterOptIdFilterAssetId' enum
 */
public sealed class FilterOptIdFilterAssetId : ModelEnum {
    /**
     ...
     * 'AcceptAll' variant
     */
    public class AcceptAll : FilterOptIdFilterAssetId() {
    ...
    public companion object :
        ScaleReader<FilterOptIdFilterAssetId>,
        ScaleWriter<FilterOptIdFilterAssetId> {
        public override fun read(reader: ScaleCodecReader): FilterOptIdFilterAssetId = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptIdFilterAssetId) {
