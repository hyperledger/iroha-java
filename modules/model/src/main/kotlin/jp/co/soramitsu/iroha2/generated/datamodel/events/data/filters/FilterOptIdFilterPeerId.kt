 ...
 *
 * Generated from 'iroha_data_model::events::data::filters::FilterOptIdFilterPeerId' enum
 */
public sealed class FilterOptIdFilterPeerId : ModelEnum {
    /**
     ...
     * 'AcceptAll' variant
     */
    public class AcceptAll : FilterOptIdFilterPeerId() {
    ...
    public companion object :
        ScaleReader<FilterOptIdFilterPeerId>,
        ScaleWriter<FilterOptIdFilterPeerId> {
        public override fun read(reader: ScaleCodecReader): FilterOptIdFilterPeerId = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptIdFilterPeerId) {
