...
public sealed class FilterOptOfAssetEventFilter : ModelEnum {
    ...
    public class AcceptAll : FilterOptOfAssetEventFilter() {
        ...
        public companion object : ScaleReader<AcceptAll>, ScaleWriter<AcceptAll> {
            ...
            public override fun hashCode(): Int = ".FilterOptOfAssetEventFilter.AcceptAll".hashCode()
        }
    }
    ...
    public companion object :
        ...
        public override fun read(reader: ScaleCodecReader): FilterOptOfAssetEventFilter = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptOfAssetEventFilter) {
