...
public sealed class FilterOptOfRoleFilter : ModelEnum {
    ...
    public class AcceptAll : FilterOptOfRoleFilter() {
        ...
        public companion object : ScaleReader<AcceptAll>, ScaleWriter<AcceptAll> {
            ...
            public override fun hashCode(): Int = ".FilterOptOfRoleFilter.AcceptAll".hashCode()
        }
    }
    ...
    public companion object : ScaleReader<FilterOptOfRoleFilter>, ScaleWriter<FilterOptOfRoleFilter> {
        public override fun read(reader: ScaleCodecReader): FilterOptOfRoleFilter = when (
            val
        ...
        public override fun write(writer: ScaleCodecWriter, instance: FilterOptOfRoleFilter) {
