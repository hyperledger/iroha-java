...
open class IrohaContainer : GenericContainer<IrohaContainer> {
    ...
    constructor(config: IrohaConfig) : super(
        ...
        this.withNetwork(config.networkToJoin)
            ...
            .withEnv("WSV_WASM_RUNTIME_CONFIG", "{\"FUEL_LIMIT\":400000000, \"MAX_MEMORY\": 524288000}")
    ...
    companion object {
        ...
        const val DEFAULT_IMAGE_TAG = "fix_original_wasm"
        const val DEFAULT_IMAGE_NAME = "erigara/iroha2"
