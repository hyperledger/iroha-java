    ...
    public class FindAssetsByAccountIdAndAssetDefinitionId(
        ...
        public companion object :
            ...
            public override fun write(
                ...
                jp.co.soramitsu.iroha2.generated.datamodel.query.asset.FindAssetsByAccountIdAndAssetDefinitionId.write(
                    writer,
                    instance.findAssetsByAccountIdAndAssetDefinitionId
                )
            }
    ...
    public companion object : ScaleReader<QueryBox>, ScaleWriter<QueryBox> {
        ...
        public override fun write(writer: ScaleCodecWriter, instance: QueryBox) {
            ...
            when (val discriminant = instance.discriminant()) {
                ...
                12 -> FindAssetsByAccountIdAndAssetDefinitionId.write(
                    writer,
                    instance as
                        FindAssetsByAccountIdAndAssetDefinitionId
                )
                13 -> FindAssetsByDomainNameAndAssetDefinitionId.write(
                    writer,
                    instance as
                        FindAssetsByDomainNameAndAssetDefinitionId
                )
